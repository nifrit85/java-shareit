...
public class ItemController {
    ...
    public ItemDto create(@RequestHeader(OWNER_ID) Long ownerId,
        ...
        return ItemMapper.toDto(itemService.create(itemDto, ownerId));
    }
    ...
    public ItemDto update(@RequestHeader(OWNER_ID) Long ownerId,
        ...
        return ItemMapper.toDto(itemService.update(itemDto, itemId, ownerId));
    }

    @GetMapping("/{itemId}")
    public ItemDto get(//@RequestHeader(OWNER_ID) Long ownerId,
                       @PathVariable Long itemId) {
